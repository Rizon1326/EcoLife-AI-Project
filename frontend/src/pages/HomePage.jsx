    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8">
        ...
        <p className="text-lg text-gray-600">
          ...
          Choose a section from below to explore more.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Classify Waste</h2>
          <p className="text-gray-600 text-sm">Learn to properly classify waste</p>
        </Link>
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Health Insights</h2>
          <p className="text-gray-600 text-sm">Get health and wellness insights</p>
        </Link>
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Food Recommendations</h2>
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Food Alternatives</h2>
