...
async def recommend_food(data: FoodRecommendationRequest):
    ...
    if data.specific_food:
        query += f""" Include recommendations for {data.specific_food} consumption:
               ...
               6. Sections should be in tabular format."""
